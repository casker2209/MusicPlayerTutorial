...
public class GenreScreenAdapter extends BaseFragmentAdapter<GenreListScreenFragment,Genre> {
    public GenreScreenAdapter(Context context, List<Genre> list,GenreListScreenFragment fragment) {
    ...
    public class GenreHolder extends GenreScreenAdapter.BaseHolder {
